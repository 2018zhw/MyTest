    ...
    window.audioProcessor.prototype = {
        ...
        createPlayer_: function(container){//创建canvas和进度条
            ...
            imgPlay.src = "./images/voice-play.png";
            ...
            spanTimeDigit.style.fontSize = "16px";
            ...
            imgSound.src = "./images/voice-sound.png";
            imgSound.volumn = 100;
        ...
        end_: function(instance) {
            ...
            if(Math.floor(_this.audioContext.currentTime - _this.startAt + _this.seekAtTime -_this.duration>=0)){
                ...
                _this.player.src = "./images/voice-play.png";
                _this.seekAtTime = 0;
        ...
        playPause: function(Seektime){
            var _this = this;
            _this.player.src = "./images/voice-pause.png";
        ...
        _drawSpectrum: function(analyser) {
                ...
                meterWidth = _this.meterWidth, //width of meters in the spectrum   =14
                gap = _this.gap, //gap between meters  =2
